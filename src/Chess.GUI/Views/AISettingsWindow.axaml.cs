...
public class AISettingsWindow : Window
{
    ...
    /// <summary>
    ///     Called when the checkbox for using the better evaluator is clicked
    /// </summary>
    /// <param name="sender">The object that owns the event.</param>
    /// <param name="e">The event.</param>
    private void UseBetterEvaluator_OnClick(object? sender, RoutedEventArgs e)
    {
        UseBetterEvaluator = !UseBetterEvaluator;
    }
    ...
    /// <param name="sender">The object that owns the event.</param>
    /// <param name="e">The event.</param>
    private void UseBook_OnClick(object? sender, RoutedEventArgs e)
    {
        UseBook = !UseBook;
    }

    /// <summary>
    ///     Called when the checkbox for using iterative deepening is clicked
    /// </summary>
    /// <param name="sender">The object that owns the event.</param>
    /// <param name="e">The event.</param>
    private void UseIterativeDeepening_OnClick(object? sender, RoutedEventArgs e)
    {
