...
namespace Chess.GUI.Libraries.ColorPicker.Structures
{
    public struct ColorTemperature
    {
        ...
        public static ColorTemperature Hot => new(1000);
        public static ColorTemperature Warm => new(2200);
        public static ColorTemperature Neutral => new(4500);
        public static ColorTemperature Cool => new(9000);
        public static ColorTemperature Cold => new(11000);
        ...
        public CIEXYZColor ToXYZ()
        {
            ...
            else if (T > 4000 && T <= 25000) xc = -3.0258469 * arg1 + 2.1070379 * arg2 + 0.2226347 * arg3 + 0.240390;
            ...
            else if (T > 4000 && T <= 25000) yc = +3.0817580 * xc3 - 5.87338670 * xc2 + 3.75112997 * xc - 0.37001483;
