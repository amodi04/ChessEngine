...
public static class MoveFactory
{
    ...
    public static IMove CreateMove(Board board, Piece movedPiece, int toCoordinate,
        MoveType moveType = MoveType.NormalMove, Piece? capturedPiece = null, Piece castlingRook = null!,
        ...
        Piece? capturedPiece, bool isEnPassant)
    {
        return new CaptureMove(board, movedPiece.PiecePosition, toCoordinate, movedPiece, capturedPiece
            ?? throw new ArgumentNullException(nameof(capturedPiece)), isEnPassant);
    }
