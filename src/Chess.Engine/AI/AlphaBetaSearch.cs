...
namespace Engine.AI
{
    ...
    public class AlphaBetaSearch
    {
        ...
        {
            // Start watch for timing the algorithm
        ...
        private int AlphaBeta(Board board, int depth, int alpha, int beta, bool maximisingPlayer)
        {
            ...
            {
                // Increase the moves evaluated counter
                _movesEvaluated++;
            ...
            if (maximisingPlayer)
            {
                ...
                foreach (var move in orderedMoves)
                {
                    ...
                    if (boardTransition.Status == MoveStatus.Done)
                    {
                        ...
                        int eval = AlphaBeta(boardTransition.ToBoard, depth - 1, alpha, beta, false);
            ...
            else
            {
                ...
                foreach (var move in orderedMoves)
                {
                    ...
                    if (boardTransition.Status == MoveStatus.Done)
                    {
                        ...
                        int eval = AlphaBeta(boardTransition.ToBoard, depth - 1, alpha, beta, true);
